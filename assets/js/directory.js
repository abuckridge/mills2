...
function createCard(page,rowString) {
  ...
  //console.log("about to create card.");
    ...
    if (page.filename) {
      ...
      rowString += '<div style="color:#fff; height:500px; width:100%; background-size:100% 100%; background-image: linear-gradient(rgba(0, 0, 0, 0),rgba(0, 0, 0, .5)), url(\'/sites/images/' + page.image + '\')">';
